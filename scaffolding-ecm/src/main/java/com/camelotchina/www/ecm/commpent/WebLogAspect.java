package com.camelotchina.www.ecm.commpent;

import com.alibaba.fastjson.JSONObject;
import com.camelotchina.www.common.component.BaseWebLogAspect;
import com.camelotchina.www.common.enums.OpLogSystem;
import com.camelotchina.www.dao.model.OperateLog;
import com.camelotchina.www.service.OperateLogService;
...
public class WebLogAspect extends BaseWebLogAspect {
    ...
    protected void saveLog(String system, String operateDesc, String uri, String ip, String args, Date operateTime) {
        try {
            ...
            if(system==null){
                operateLog.setSystem(OpLogSystem.ECM.toString());
            }
