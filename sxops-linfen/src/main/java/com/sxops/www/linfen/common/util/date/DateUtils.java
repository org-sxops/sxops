package com.sxops.www.linfen.common.util.date;

import com.sxops.www.linfen.common.constant.Const;
...
public class DateUtils {
	...
	public static boolean compareNowHours(Date targetDate, Date targetTime){
		...
		Date nowTime = StringToDate(DateUtils.getHour(date) + Const.SEPARATOR_COLON + DateUtils.getMinute(date) + Const.SEPARATOR_COLON + DateUtils.getSecond(date), DateStyle.HH_MM_SS);
