 ...
 * @author  <a href="mailto: wuyingya@sxops.com">吴迎亚</a>
 * @version 1.0 
...
public class RedisDB {
	...
	/**
	 * <p>Discription: [分布式锁] </p>
	 * Created on: 2018/1/18 17:34
	 *
	 * @author [邓江]
	 */
	public boolean lock(String key, long timeout) {
		Boolean r = redisTemplate.opsForValue().setIfAbsent(key, System.currentTimeMillis());
		if (r) {
	...
	public boolean lock(String key, String str) {
		Boolean r = redisTemplate.opsForValue().setIfAbsent(key, str);
		return r;
	}
